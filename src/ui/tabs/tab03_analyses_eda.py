        ...
        if selected_metrics and not filtered_data.empty:
            for metric in selected_metrics:
                ...
                with col1:
                    ...
                    st.plotly_chart(fig_hist, width='stretch', key=f"eda_histogram_{metric}")
                ...
                with col2:
                    ...
                    st.plotly_chart(fig_box, width='stretch', key=f"eda_boxplot_{metric}")
                ...
                with st.expander("Série temporelle complète", expanded=True):
                    ...
                    st.plotly_chart(fig_ts, width='stretch', key=f"eda_timeseries_{metric}")
                ...
                with col1:
                    ...
                    if len(daily_avg) > 0:
                        ...
                        st.plotly_chart(fig_daily, width='stretch', key=f"eda_daily_avg_{metric}")
                ...
                with col2:
                    ...
                    if len(hourly_avg) > 0:
                        ...
                        st.plotly_chart(fig_hourly, width='stretch', key=f"eda_hourly_profile_{metric}")
