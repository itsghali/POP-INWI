    ...
    if clim_columns and 'Temp_Ambiante' in filtered_merged_data.columns:
        ...
        if stop_points:
            ...
            if temp_changes:
                ...
                st.plotly_chart(fig, use_container_width=True, key="clim_impact_analysis")
                ...
                with col1:
                    ...
                    st.plotly_chart(fig_hist, use_container_width=True, key="clim_temp_change_histogram")
                ...
                with col2:
                    ...
                    st.plotly_chart(fig_box, use_container_width=True, key="clim_temp_change_boxplot")
                ...
                if event_idx is not None:
                    ...
                    if len(viz_data) > 0:
                        ...
                        st.plotly_chart(fig_timeline, use_container_width=True, key="clim_temp_timeline")
