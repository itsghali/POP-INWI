...
def render_tab(filtered_merged_data, start_date, end_date):
    ...
    if all(col in filtered_merged_data.columns for col in ['Puissance_IT', 'Puissance_CLIM', 'Puissance_Generale']):
        ...
        if pricing_mode == "Tarif unique":
            ...
            st.plotly_chart(fig_rates, use_container_width=True, key="energy_rates_chart")
        ...
        if pricing_mode == "Tarifs variables par période de la journée":
            ...
            with col1:
                ...
                st.plotly_chart(fig_hourly, use_container_width=True, key="hourly_cost_profile")
        ...
        if simulate_button or True:  # Always show results for better UX
            ...
            st.plotly_chart(fig_comparison, use_container_width=True, key="cost_scenario_comparison")
